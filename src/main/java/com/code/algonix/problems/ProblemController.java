...
public class ProblemController {
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasRole('ADMIN')")
    @Operation(summary = "Masalani yangilash (full)", description = "Faqat ADMIN")
    ...
    @PatchMapping("/{id}")
    @PreAuthorize("hasRole('ADMIN')")
    @Operation(summary = "Masalani qisman yangilash", description = "Faqat ADMIN - faqat yuborilgan fieldlar yangilanadi")
